...
Deno.test("js_test/doublylinkedlist.ts ->  (line 202)", () => {
...
Deno.test("js_test/linkedlist.ts -> Linkedlist.map (line 84)", () => {
  const testArr = [1, 2, 3, 4, 5, 6, 78, 9, 0, 65];
...
Deno.test("js_test/linkedlist.ts -> Linkedlists.compareWith (line 147)", () => {
  const testArr = [1, 2, 3, 4, 5, 6, 78, 9, 0, 65];
...
Deno.test("js_test/nested/linkedlist.ts -> Linkedlists.map (line 84)", () => {
  const testArr = [1, 2, 3, 4, 5, 6, 78, 9, 0, 65];
...
Deno.test("js_test/nested/linkedlist.ts -> Linkedlist.compareWith (line 147)", () => {
  const testArr = [1, 2, 3, 4, 5, 6, 78, 9, 0, 65];
...
Deno.test("js_test/nested/nested/doublylinkedlist.js -> DoublyLinkedList.map (line 191)", () => {
  const testArr = [1, 2, 3, 4, 5, 6, 78, 9, 0, 65];
